    ...
    buttons.forEach(btn => {
        btn.addEventListener('click', (e) => {
            const btnPressed = e.target.textContent
                if (!operation.input1 || display.textContent === '0') {
                    ...
                    display.textContent = (!operation.input2 || display.textContent === '0') ? btnPressed : display.textContent + btnPressed;
...
function backspace() {
    ...
    del.addEventListener('click', (e) => {
        if (display.textContent.length > 1 && operation.prevoperator !== '=') {
